...
import { BedroomItem } from "@/global/types";
...
const BedroomInterior: React.FC = () => {
    const bedroomItems: BedroomItem[] = [
        {
            ...
            description: 'Tranquil bedroom design with calming colors and plush textures.',
        ...
        },
        {
            ...
            features: ['Floor-to-Ceiling Windows', 'Marble Finishes', 'Contemporary Furniture'],
            bedSize: 'King',
            theme: 'Modern',
            rating: 4.9,
        },
    ...
    return (
        <div className="container mx-auto p-4 bg-gradient-to-br from-purple-50 to-indigo-50 h-screen w-screen overflow-x-hidden">
            <h1 className="text-3xl font-bold text-center text-gray-800 mb-8">Dreamy Bedroom Interiors</h1>
