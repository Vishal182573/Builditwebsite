      ...
      {isMenuOpen && (
        <div className="md:hidden bg-black backdrop-blur-sm bg-opacity-40">
          <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
            <MobileNavLink href="/" textColor={textColor} onClick={closeMenu}>
              <FaHome />
              <span>Home</span>
            </MobileNavLink>
            <MobileNavLink href="/services" textColor={textColor} onClick={closeMenu}>
              <FaServicestack />
              <span>Services</span>
            </MobileNavLink>
            <MobileNavLink href="/properties" textColor={textColor} onClick={closeMenu}>
              <FaBuilding />
              <span>Properties</span>
            </MobileNavLink>
            <MobileNavLink href="/gallery-interior" textColor={textColor} onClick={closeMenu}>
              <FaCouch />
              <span>Gallery</span>
            </MobileNavLink>
            <MobileNavLink href="/interiors" textColor={textColor} onClick={closeMenu}>
              <FaBath />
              <span>Interior</span>
            </MobileNavLink>
...
const NavLink = ({ href, children, textColor }: NavLinkProps) => {
  return (
    <Link
      href={href}
...
const MobileNavLink = ({ href, children, textColor, onClick }: MobileNavLinkProps) => {
  return (
    <Link
      href={href}
