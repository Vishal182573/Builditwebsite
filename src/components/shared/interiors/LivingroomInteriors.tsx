...
import { LivingRoomItem } from "@/global/types";
...
const LivingRoomCatalog: React.FC = () => {
    const livingRoomItems: LivingRoomItem[] = [
        {
            ...
            style: 'Contemporary',
            size: '400 sq ft',
            features: ['Open Concept', 'Smart Home Integration', 'Floor-to-Ceiling Windows'],
        },
        {
            id: 2,
    ...
    return (
        <div className="container mx-auto p-4 bg-gradient-to-br from-teal-50 to-blue-50 h-screen w-screen overflow-x-hidden">
            <h1 className="text-3xl font-bold text-center text-gray-800 mb-8">Inspiring Living Room Designs</h1>
